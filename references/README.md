...
Bottom-up dimension files. These are the raw distillations. `../methodology.md` is the converged SSOT. `../SKILL.md` is the engine. If they conflict, obey `methodology.md`.

| File | Dimension | What it holds |
|---|---|---|
| `claims.md` | Repeated laws | Clustered hard claims with tweet id + quote |
| `procedures.md` | Operating steps | Only steps he actually wrote |
